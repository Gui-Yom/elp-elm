...
var $author$project$Main$ProgramTextUpdated = function (a) {
	return {$: 'ProgramTextUpdated', a: a};
};
var $author$project$ProgramList$init = {procDefHovered: $elm$core$Maybe$Nothing, procRefHovered: $elm$core$Maybe$Nothing};
...
var $author$project$Program$Repeat = F2(
	function (a, b) {
...
var $author$project$Program$Call = function (a) {
	return {$: 'Call', a: a};
};
			...
			return $elm$parser$Parser$oneOf(
				_List_fromArray(
					[
						...
						$elm$parser$Parser$map,
						function (_v0) {
							return $elm$parser$Parser$Done(procs);
						},
	...
	if (_v0.$ === 'Err') {
		...
		return _Utils_Tuple2(
			...
			A2(
				$elm$core$List$map,
				function (e) {
					return $author$project$Program$SyntaxError(e);
				},
				err));
	} else {
		var prog = _v0.a;
		return _Utils_Tuple2(
			$elm$core$Maybe$Just(prog),
			$author$project$Program$checkProgram(prog));
	}
};
var $elm$json$Json$Encode$string = _Json_wrap;
var $author$project$LocalStorage$saveProgText = _Platform_outgoingPort('saveProgText', $elm$json$Json$Encode$string);
var $author$project$ProgramList$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'ProcRefHover':
				var hovering = msg.a;
				return _Utils_update(
					model,
					{
						procRefHovered: $elm$core$Maybe$Just(hovering)
					});
			case 'ProcDefHover':
				var hovering = msg.a;
				return _Utils_update(
					model,
					{
						procDefHovered: $elm$core$Maybe$Just(hovering)
					});
			default:
				return _Utils_update(
					model,
					{procDefHovered: $elm$core$Maybe$Nothing, procRefHovered: $elm$core$Maybe$Nothing});
		}
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		if (msg.$ === 'ProgramListMsg') {
			var plmsg = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						plModel: A2($author$project$ProgramList$update, plmsg, model.plModel)
					}),
				$elm$core$Platform$Cmd$none);
		} else {
			var newProgText = msg.a;
			var _v1 = $author$project$Program$parseProgram(newProgText);
			var mprog = _v1.a;
			var errors = _v1.b;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						current: function () {
							if (mprog.$ === 'Just') {
								var prog = mprog.a;
								return $elm$core$Maybe$Just(prog);
							} else {
						...
						valid: $elm$core$List$isEmpty(errors) ? mprog : model.valid
					}),
				$author$project$LocalStorage$saveProgText(newProgText));
		}
	});
...
var $author$project$Main$init = function (flags) {
	return A2(
		...
		$author$project$Main$ProgramTextUpdated(
			A2($elm$core$Maybe$withDefault, '', flags)),
		{current: $elm$core$Maybe$Nothing, errors: _List_Nil, plModel: $author$project$ProgramList$init, progText: '', valid: $elm$core$Maybe$Nothing});
};
...
var $author$project$Main$ProgramListMsg = function (a) {
	return {$: 'ProgramListMsg', a: a};
};
...
var $author$project$Canvas$correctAngle = function (angle) {
...
var $author$project$ErrorList$view = function (errors) {
	return A2(
		...
		_List_fromArray(
			[
				$elm$html$Html$Attributes$id('errorList')
			]),
		A2(
			$elm$core$List$map,
			function (e) {
...
var $author$project$ProgramList$ProcRefHover = function (a) {
...
var $author$project$ProgramList$showProc = F2(
	function (model, proc) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('procList')
				]),
			A2(
				$elm$core$List$map,
				function (inst) {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$html$Html$Lazy$lazy, $author$project$Canvas$view, model.valid)
					]))
			]));
};
